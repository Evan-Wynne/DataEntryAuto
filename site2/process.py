...
def process_input(input_text):
    print("Received input:", input_text[:500])  # Print the first 500 characters of input for debugging
...
DL""")
    ...
    formatted_results = "<br>".join(["\t".join(map(str, result)) for result in results])
